...
global.upgrade_puzzle = 0;  //cria 4 totens q deixam o boss invulnerável
global.upgrade_bullet=0;  //mais bullets
global.upgrade_explosion=0; //invoca explosoes
global.upgrade_speed=0; //mais veloz
global.upgrade_minions=0; //invoca mais minions
